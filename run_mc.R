...
SI_q_mean<-aggregate(data.frame(q=data$q_mod[data$tiefe==-17],SI=data$SI[data$tiefe==-17],SI_q=data$SI_q[data$tiefe==-17]),list(treatment=data$treatment[data$tiefe==-17]),function(x) mean(x,na.rm=T))
